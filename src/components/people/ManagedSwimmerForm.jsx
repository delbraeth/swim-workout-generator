      ...
      return (
        <div>
          ...
          <input value={form.display_name} onChange={e => upd("display_name", e.target.value)}
            placeholder="e.g. Sarah Johnson" aria-label="Display name" style={inputStyle} />
          {teamOptions.length > 0 && (
            <>
              <label style={labelStyle}>Team affiliation</label>
              <select value={form.team_id || ""} onChange={e => upd("team_id", e.target.value)} aria-label="Team affiliation" style={inputStyle}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
            <div>
              ...
              <input value={form.initials} onChange={e => upd("initials", e.target.value)}
                placeholder="SJ" aria-label="Initials" maxLength={4} style={inputStyle} />
            </div>
            <div>
            ...
            <div>
              ...
              <select value={form.gender || ""} onChange={e => upd("gender", e.target.value)} aria-label="Gender" style={inputStyle}>
          ...
          <input value={form.class_year} onChange={e => upd("class_year", e.target.value.replace(/\D/g, "").slice(0, 4))}
            placeholder="e.g. 2027" aria-label="Class year (graduation year)" maxLength={4} inputMode="numeric" style={inputStyle} />
          <div style={{ fontSize: 10, color: "var(--color-text-dim)", marginTop: 4 }}>
          ...
          <select value={form.lesson_level || ""} onChange={e => upd("lesson_level", e.target.value)} aria-label="Lesson level" style={inputStyle}>
          ...
          <input value={form.parental_contact} onChange={e => upd("parental_contact", e.target.value)}
            placeholder="parent@example.com" aria-label="Parental contact (email or phone)" maxLength={255} style={inputStyle} />
